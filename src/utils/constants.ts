...
export const RPC_URLS = {
  ...
  4: process.env.REACT_APP_RINKEBY_RPC || 'https://eth-rinkeby.alchemyapi.io/v2/8OgV3avdpzXyJujytN1QmXG5TLqqGCyG',
  137: process.env.REACT_APP_POLYGON || 'https://polygon-mainnet.g.alchemy.com/v2/KPAeLTP7DM-wzAcPyJPfXgr4ZwniE6YH',
  80001: process.env.REACT_APP_MUMBAI || 'https://polygon-mumbai.g.alchemy.com/v2/r4Crw3pW-4jfWKjon-ijnD0AjlFJGLQj',
};
...
export const TESTNEXT_TOKENSLIST: { [key: number]: Array<any> } = {
  4: [
    {
...
export const INKPURCHASE_ADDRESSES: { [chainId: number]: string } = {
  1: process.env.REACT_APP_INKPURCHASE_ETHEREUM || '0xb27308f9F90D607463bb33eA1BeBb41C27CE5AB6',
  4: process.env.REACT_APP_INKPURCHASE_RINKEBY || '0xd2465b01600d5a585fdFb56783cfc32DF420af25',
  137: process.env.REACT_APP_INKPURCHASE_POLYGON || '0xbF77b5E9f0195E336690c671c860e3707F60FbEe',
  80001: process.env.REACT_APP_INKPURCHASE_MUMBAI || '0x7d3a56D97C225f9C15f704E10141F62Cd260BbFA',
};

export const QUOTER_ADDRESS = process.env.REACT_APP_QUOTER_CONTRACT || '0xb27308f9F90D607463bb33eA1BeBb41C27CE5AB6';
