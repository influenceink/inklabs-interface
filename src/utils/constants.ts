...
export const INKPURCHASE_ADDRESSES: { [chainId: number]: string } = {
  ...
  4: process.env.REACT_APP_INKPURCHASE_RINKEBY || '0x15d37C8ED6C6895BE39Ed5D6644BCA4E6Bab8830',
  137: process.env.REACT_APP_INKPURCHASE_POLYGON || '0x465b4C99f7A2D8Bc57ec7d8d06531852E8C310Ba',
  80001: process.env.REACT_APP_INKPURCHASE_MUMBAI || '0x1D244B2b0DbBadBbe3ea3dD60a1e54C0eAD59E73',
};
